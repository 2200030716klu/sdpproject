...
<div class ="card-container">
    ...
    <div class="line">PROFILE : <a href="viewborrowerprofile?bid=${borrower.id}">Profile</a> <br/></div>
    <div class="line">LOANS : <a href="viewborrowerloans?bname=${borrower.name}"> Loans </a>  <br/></div>
    <div class="line">TRANSACTIONS : <a href="viewborrowertransactions?bname=${borrower.name}"> Transactions </a> <br/></div>
