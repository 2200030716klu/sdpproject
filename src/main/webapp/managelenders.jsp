...
<div class ="card-container">
    ...
    <div class="line">  <a href="adminupdatelrprofile?lid=${lender.id}">Update</a> <br/></div>
    <div class="line">  <a href="deletelender?lid=${lender.id}">Delete</a> <br/></div>
